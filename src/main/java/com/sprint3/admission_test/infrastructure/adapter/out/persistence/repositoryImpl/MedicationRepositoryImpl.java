...
public class MedicationRepositoryImpl implements IMedicationRepository {
    ...
    @Override
    public List<Medication> findByCategoryandAfterExpiracionDate(Category category, LocalDate expiration_date) {
        return medicationJpaRepository.findByCategoryAndExpirationDateAfter(category,expiration_date);
    }
}
